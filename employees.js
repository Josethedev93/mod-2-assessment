...
//CODE HERE
const empOne = new Employee('syd', 'weekday mornings, weekday afternoons')
/*
...
//CODE HERE
const manager = new Manager('winston', ['works weekday mornings and weekday afternoons'], ['cece, schmidt'])
